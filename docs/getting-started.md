...
4. 使用 `dot apply --dry-run` 阅读全部 action 和 warning/blocker issue；
...
- [故障排查](guides/troubleshooting.md)：从 action 和 warning/blocker issue 定位输入事实；
