...
- [x] 2026-07-20：executor/planner/paths 窄测、executor 20 次重复、race、Linux/amd64 test
  ...
  等待独立复核。
- [x] 2026-07-20：未参与实现的 reviewer 对 `f4522b0...d940a52` 完整复核 GO，无 P0–P3；
...
Milestone 已达到 review-ready。branch 基线为 `f4522b03d22b`，未参与实现的 reviewer 完整复核
...
本地证据：
    ...
    git diff f4522b03d22b6153c25cc44f4c5c847aae30fc0c...HEAD --check
    make check BINARY=/private/tmp/dot-m1-cp4-scaffold-final-gate
