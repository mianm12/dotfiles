...
实现已完成并保持 active，交由 coordinator 安排未参与实现的 reviewer。相对 current main
`1a7e0fc` 的 branch 包含 freshness merge commit `1f11fcd`、计划 commit `1290501` 和两个行为
commit `8aa2a81`、`a8c4d35`；共享 model、decision/prune、manifest 接缝未修改。
