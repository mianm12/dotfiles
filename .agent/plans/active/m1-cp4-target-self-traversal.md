...
Linux/amd64 apply test binary 交叉编译、`git diff 34f8609...abf081c --check` 和
`make check BINARY=/private/tmp/dot-m1-cp4-self-traversal-check/dot` 全部通过。worktree clean；
