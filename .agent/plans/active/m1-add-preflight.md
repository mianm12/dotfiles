...
实现阶段完成，计划保持 active 等待独立复核。`8d22f24` 建立精确 prospective source overlay，
...
state/control/source 三变体与系统 Git trackability gate，M1 template fail closed。
...
Milestone 实现门禁通过，远端待验收；独立 review 未开始，因此不迁移 completed、不声称
review-ready。
